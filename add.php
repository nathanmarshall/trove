...
//PHP for IMAGE uploading
			...
			// //resize image
			// $uploaded_file = new Imagick($uploaded_file);

			// $uploaded_file->resizeImage($newWidth,$newHeight, imagick::FILTER_LANCZOS, 0.9, true);

			// $im->writeImage("localhost:8888/trove/images");
